...
function add_to_cart($goods_id, $num = 1, $spec = array(), $parent = 0) {
    ...
    $discount = 1; // $_SESSION[discount]
    $userRank = '0'; // $_SESSION[user_rank]
    ...
    foreach ($basic_list as $parent_id => $fitting_price)
    {
        ...
        $gBricker->db->insert('cart', $parent);
    ...
    /* 把赠品删除 */
    $sql = "DELETE FROM ecs_cart WHERE session_id = '" . SESS_ID . "' AND is_gift <> 0";
    $gBricker->db->query($sql);
