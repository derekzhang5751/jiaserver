...
class Session
{
    ...
    function insert_session()
    {
        ...
        return $this->db->insert($this->session_table, $params);
    }

    function load_session()
    {
        $session = $this->db->get($this->session_table,
        ...
        else
        {
            ...
            {
                $session_data = $this->db->get($this->session_data_table,
                    ['data', 'expiry'],
                    ['sesskey' => $this->session_id]);
    ...
    function update_session()
    {
        ...
        $this->db->update($this->session_table,
            [
                'expiry' => $this->_time,
                'ip' => $this->_ip,
                'userid' => $userid,
